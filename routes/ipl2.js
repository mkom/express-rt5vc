        ...
        const houses = await House.find()
          ...
          return houses.map(house => {
            ...
            const filteredMonthlyFees = house.monthly_fees.filter(mf => {
              ...
              return mfMonth >= "2024-07" && mfMonth <= currentMonth && (correspondingMonthlyStatus && (correspondingMonthlyStatus.status === "Isi" || correspondingMonthlyStatus.status === "Weekend"));
            });
